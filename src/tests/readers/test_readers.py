...
class TestReaders:
    ...
    def test_autoabstract(self, workbook: Any) -> None:
        """
        ...
        models = AutoabstractReader(workbook).read()

        assert len(models) == 1
        model = models[0]

        model_type = AutoabstractModel
